...
function card({name, image1, image2, repo, website}){
  ...
  return (
    ...
    <motion.div className="min-h-[10rem] max-h-[30rem] min-w-[30rem] p-2 bg-white border border-gray-200 rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700 m-2">
      ...
      <p className="m-2 font-normal text-gray-700 dark:text-gray-400">Here are the biggest enterprise technology acquisitions of 2021 so far, in reverse chronological order.</p>
